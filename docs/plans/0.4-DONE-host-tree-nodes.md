...
**ℹ️** Builds on **`docs/plans/0.3-DONE-session-states-history-guake.md`**. Gateway + nest + flat search shipped.
**ℹ️** Follow-on chrome (add group, DnD, LXC console/attach) → **`docs/plans/0.9-tidy-up.md`**. VTE right-click → **`0.11-DONE-vte-context-menu.md`**.
...
- **ℹ️** Tree DnD, add/edit group, LXC **console** / **attach** context menu — moved to **`docs/plans/0.9-tidy-up.md`** so this plan can close.
...
- **ℹ️** Add group / console-attach / tree DnD → **`docs/plans/0.9-tidy-up.md`**.
