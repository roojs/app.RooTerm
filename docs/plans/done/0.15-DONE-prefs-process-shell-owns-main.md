...
**➡️** Prefs process, ConfigUpdate D-Bus, save split, cleanup → **[0.15.1](0.15.1-DONE-prefs-process-dbus-cleanup.md)**.
...
- **🔷** Prefs process, ConfigUpdate D-Bus, cleanup, and **config/tree save split** → **`docs/plans/done/0.15.1-DONE-prefs-process-dbus-cleanup.md`**.
