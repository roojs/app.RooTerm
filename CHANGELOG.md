...
- Selecting a host with no sessions no longer jumps to an open child (wrong LXC / host)
- Typing in host search keeps focus in the search box instead of the VTE
